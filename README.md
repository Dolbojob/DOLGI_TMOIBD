...
**Шаг 1.** Переводим $z = 1 + i\sqrt{3}$ в тригонометрическую форму:
...
**Шаг 2.** Применяем формулу корня $n$-й степени:

$$z_k = \sqrt[6]{2}\left(\cos\frac{\frac{\pi}{3}+2\pi k}{6} + i\sin\frac{\frac{\pi}{3}+2\pi k}{6}\right), \quad k=0,1,2,3,4,5$$

$$z_k = 2^{1/6}\left(\cos\frac{\pi + 6\pi k}{18} + i\sin\frac{\pi + 6\pi k}{18}\right)$$

| $k$ | Аргумент | $z_k$ |
|-----|----------|--------|
| 0 | $\pi/18$ | $2^{1/6}(\cos\frac{\pi}{18}+i\sin\frac{\pi}{18})$ |
| 1 | $7\pi/18$ | $2^{1/6}(\cos\frac{7\pi}{18}+i\sin\frac{7\pi}{18})$ |
| 2 | $13\pi/18$ | $2^{1/6}(\cos\frac{13\pi}{18}+i\sin\frac{13\pi}{18})$ |
| 3 | $19\pi/18$ | $2^{1/6}(\cos\frac{19\pi}{18}+i\sin\frac{19\pi}{18})$ |
| 4 | $25\pi/18$ | $2^{1/6}(\cos\frac{25\pi}{18}+i\sin\frac{25\pi}{18})$ |
| 5 | $31\pi/18$ | $2^{1/6}(\cos\frac{31\pi}{18}+i\sin\frac{31\pi}{18})$ |
