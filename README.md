...
График многочлена четвёртой степени. Красными точками отмечены **вещественные корни** (точки пересечения с осью $x$).

<img src="mnojestvo/polynomial/.png" width="600">
...
<img src="mnojestvo/determinant.png" width="600">
...
<img src="mnojestvo/slu_comparison.png" width="600">
...
<img src="mnojestvo/fsr.png" width="600">
...
3D-график показывает базисные векторы $a$, $b$, $c$ и целевой вектор $d$. Вектор $d$ — линейная комбинация базисных векторов с найденными коэффициентами.

<img src="mnojestvo/basis_decomposition.png" width="600">
...
<img src="mnojestvo/eigenvalues_v1.png" width="600">
